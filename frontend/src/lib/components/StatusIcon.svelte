...
{#if isSpinning}
    <div class="{containerSize} flex items-center justify-center">
        <div
            class="{spinnerSize} rounded-full border-2 border-primary-500/30 border-t-primary-500 animate-spin"
        ></div>
    </div>
{:else if isSuccess}
    <div
        class="{containerSize} flex items-center justify-center bg-success-500/20 rounded-full"
    >
        <svg
...
{:else if isWarning}
    <div
        class="{containerSize} flex items-center justify-center bg-warning-500/20 rounded-full"
...
{:else if isFailed}
    <div
        class="{containerSize} flex items-center justify-center bg-error-500/20 rounded-full"
    >
        <svg
